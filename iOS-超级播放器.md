...
超级播放器封装了完整的功能并提供上层UI，简单几行代码即可拥有类似腾讯视频强大的播放功能。若超级超级播放器不满足您业务的个性化需求，且您具有一定的开发经验，可以集成 [腾讯云视立方播放器 SDK](https://cloud.tencent.com/document/product/881/20216)，自定义开发播放器界面和播放功能。
